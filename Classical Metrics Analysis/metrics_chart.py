...
def create_percentage_improvement_comparison_chart(df, colors):
    ...
    plt.tight_layout()
    plt.savefig('Graphs/percentage_improvement_comparison.svg', format='svg', bbox_inches='tight',
                transparent=True)
    plt.close()
...
def create_percentage_improvement_lollipop_chart(df, colors):
    ...
    # Save chart
    plt.savefig('Graphs/percentage_improvement_lollipop.svg',
...
def create_percentage_improvement_radar_chart(df, colors):
    ...
    plt.tight_layout()
    plt.savefig('Graphs/percentage_improvement_radar.svg', format='svg', bbox_inches='tight',
                transparent=True)
    plt.close()
...
def create_percentage_improvement_line_chart(df, colors):
    ...
    plt.tight_layout()
    plt.savefig('Graphs/percentage_improvement_line.svg', format='svg', bbox_inches='tight',
                transparent=True)
    plt.close()
...
if __name__ == "__main__":
    ...
    if df is not None:
        ...
        print("\nGenerating percentage improvement Graphs (SVG format for high quality)...")

        create_percentage_improvement_comparison_chart(df, colors)
        print("✓ Horizontal improvement chart saved: Graphs/percentage_improvement_comparison.svg")

        create_percentage_improvement_lollipop_chart(df, colors)
        print("✓ Lollipop improvement chart saved: Graphs/percentage_improvement_lollipop.svg")

        create_percentage_improvement_radar_chart(df, colors)
        print("✓ Improvement radar chart saved: Graphs/percentage_improvement_radar.svg")

        create_percentage_improvement_line_chart(df, colors)
        print("✓ Improvement line chart saved: Graphs/percentage_improvement_line.svg")
